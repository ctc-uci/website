...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    event: "Game Night @ XXX (Invite Only)",
    description:
  ...
  },
  {
    ...
    description:
      "The Skill Showcase is a one-on-one meeting with our board members, where we will gauge your technical skills. Further information about what to expect will be shared in your acceptance email.",
    importantDetail:
      "You will receive an email on Oct XX if you have been invited to a Skill Showcase.",
  },
  {
    majorEvent: true,
    date: "Oct 3rd - Oct 11th",
    ...
    importantDetail:
      "You will receive an email on Oct XX if you have been invited to a Coffee Chat.",
  },
  {
    majorEvent: true,
    date: "Oct XX",
    ...
    description:
      "You will receive an email with final acceptance decisions on Oct XX. Regardless of final decisions, we want to thank you for your time and dedication!",
  },
];
